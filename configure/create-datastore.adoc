...
Weitere Informationen zur Verwendung von NVMe/FC mit VMware vSphere 7.0 finden Sie unter  https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_8.html["ONTAP NVMe/FC Host-Konfigurationshandbuch"] und  https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684"].
