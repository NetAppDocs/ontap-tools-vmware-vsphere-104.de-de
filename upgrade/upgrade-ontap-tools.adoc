...
* Wechseln Sie zum Tab „Snapshots“ und wählen Sie die Schaltfläche „Snapshot erstellen“. Erstellen Sie einen ruhenden Snapshot der VM. Weitere Informationen finden Sie unter  https://techdocs.broadcom.com/["Broadcom Technische Dokumentation"^].
